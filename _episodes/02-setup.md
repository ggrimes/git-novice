...
For this lesson, we will be interacting with Univeristy of Edinburgh's [GitLab](https://git.ecdf.ed.ac.uk/) service and so the email address and password  will  be the same as the ones you use to log into your University account.
